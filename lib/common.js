...
var CONN_PARAMS_UUID                        = 'f000ccc004514000b000000000000000';
...
var CONN_PARAMS_READ_NOTIFY_UUID            = 'f000ccc104514000b000000000000000';
var CONNECTION_PARAMS_WRITE_UUID            = 'f000ccc204514000b000000000000000';

var OAD_IMG_IDENTIFY_UUID                   = 'f000ffc104514000b000000000000000';
var OAD_IMG_BLOCK_UUID                      = 'f000ffc204514000b000000000000000';
...
SensorTagCommon.prototype.setConnectionParameters = function(connection_interval, supervision_timeout, callback) {
  var buf = new Buffer(8);
  buf.writeUInt16LE(connection_interval, 0);
  buf.writeUInt16LE(connection_interval, 2);
  buf.writeUInt16LE(0, 4);
  buf.writeUInt16LE(supervision_timeout, 6);
  this.notifyCharacteristic(CONN_PARAMS_UUID, CONN_PARAMS_READ_NOTIFY_UUID, true, onConnParamsChange.bind(this),
    function() {
      this.writeDataCharacteristic(CONN_PARAMS_UUID, CONNECTION_PARAMS_WRITE_UUID, buf, null);
    }.bind(this));

  function onConnParamsChange(data) {
    this.notifyCharacteristic(CONN_PARAMS_UUID, CONN_PARAMS_READ_NOTIFY_UUID, true, onConnParamsChange, callback);
  }

};

SensorTagCommon.prototype.onImgIdentifyChange = function(callback) {
  this.emit('imgIdentifyChange');
};

SensorTagCommon.prototype.notifyImgIdentify = function(callback) {
  this.notifyCharacteristic(OAD_UUID, OAD_IMG_IDENTIFY_UUID, true, this.onImgIdentifyChangeBinded, callback);
};

SensorTagCommon.prototype.unnotifyImgIdentify = function(callback) {
  this.notifyCharacteristic(OAD_UUID, OAD_IMG_IDENTIFY_UUID, false, this.onImgIdentifyChangeBinded, callback);
};

SensorTagCommon.prototype.notifyImgBlock = function(callback) {
  this.notifyCharacteristic(OAD_UUID, OAD_IMG_BLOCK_UUID, true, this.onImgBlockChangeBinded, callback);
};

SensorTagCommon.prototype.unnotifyImgBlock = function(callback) {
  this.notifyCharacteristic(OAD_UUID, OAD_IMG_BLOCK_UUID, false, this.onImgBlockChangeBinded, callback);
};
