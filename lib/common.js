...
SensorTagCommon.prototype.setConnectionParameters = function(callback) {
  var buf = new Buffer(8);
  buf.writeUInt16LE(OAD_CONN_INTERVAL, 0);
  buf.writeUInt16LE(OAD_CONN_INTERVAL, 2);
  buf.writeUInt16LE(0, 4);
  buf.writeUInt16LE(OAD_SUPERVISION_TIMEOUT, 6);
